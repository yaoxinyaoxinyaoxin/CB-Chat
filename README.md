...
📖 [阅读中文版](CB-Chat_CN.md) · [Read in Chinese](CB-Chat_CN.md)
...
### Problem: Uncertainty Amplification
...
### Solution: AI Unfolds Space, Humans Guide Convergence
...
| 4 | **Active Hypothesis & Discriminative Questioning** | AI generates multi-branch hypotheses and proactively asks for critical evidence |
| 5 | **Multimodal Cross-Validation & Veto** | Hard evidence (failed scripts, contradictory visual feedback) holds veto power |
| 6 | **Real-time Feedback & Correction** | From turn-based → near-real-time streaming correction |

<details>
<summary>中文 — 六大机制</summary>
...
## 🔬 CB-Paradigm Derivatives / 衍生场景

| Scenario | Positioning | Core Value |
|----------|-------------|------------|
| **CB-Chat** | Chat application | UI-layer human probability-space navigation |
| **CB-IDE** | AI coding tools (Cursor/Trae/Windsurf) | Dynamic business-condition injection; code+test+execution = multi-dim verification loop |
...
<details>
<summary>中文 — CB-Paradigm 衍生场景</summary>
...
## 🚀 Feature Checklist / 特性清单

- [ ] Visualized Condition Nodes · 条件节点可视化
- [ ] Reasoning Direction Locking · 推理方向锁定
- [ ] Dynamic Bayesian-Inspired Updating · 动态贝叶斯式更新
- [ ] Multi-step Correction & Backtracking · 多步纠偏回溯
- [ ] Active Hypothesis & Discriminative Questioning · 主动假设与鉴别提问
- [ ] Multimodal Evidence Loop & Veto Power · 多模态证据闭环与一票否决
- [ ] Harness-Integrated Verification · Harness 集成验证

---

## 🎯 Key Logic Points / 逻辑评估要点

- **Single-Modality Bottleneck**: "Semantically plausible" ≠ "factually verified." Multimodal cross-validation forms a stereoscopic verification network.
