...
| **CB-IDE** | AI 编程工具 | 每步动态注入业务条件，代码+测试+运行=多维验证闭环 |
| **CB-Agent** | 全自动智能体 | 人类作为高维贝叶斯观测节点随时注入新条件 |
| **CB-Embodied** | 具身控制 | 空间预设+实时反馈校正，机器人/辅助驾驶/运动规划 |
...
- **关键靶点识别**：以最小交互成本识别高杠杆节点
- **智能化比例指标**：AI 正确决策与自动闭环比例稳步提升
- **『甲方定律』**：判定正确与价值——最终裁决权天然在人类
...
1. **「假全自动」的代价是失控**：缺乏人类校准的长链路中，LLM 在错误假设上盲目狂奔
2. **人类角色升维，而非增加负担**：从执行者→概率空间导航员，仅在高杠杆节点轻量干预
3. **确定性的最终来源**：AI 是工具，需求的提出者（甲方）是人类
...
- [ ] Visualized Condition Nodes
- [ ] Reasoning Direction Locking
- [ ] Dynamic Bayesian-Inspired Updating
- [ ] Multi-step Correction & Backtracking
- [ ] Active Hypothesis & Discriminative Questioning
- [ ] Multimodal Evidence Loop & Veto Power
- [ ] Harness-Integrated Verification
